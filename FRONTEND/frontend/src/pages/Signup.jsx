  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative bg-gradient-to-br from-primary/10 via-background to-accent/10">
      ...
      <div className="w-full max-w-sm bg-white border-2 border-primary rounded-2xl p-8 shadow-2xl z-10 relative">
        ...
        <h1 className="text-3xl font-bold text-primary mb-2 font-[family-name:var(--font-playfair)]">Create Account</h1>
        <p className="text-base text-muted-foreground mb-8">Start your guitar journey</p>
        ...
        <p className="text-sm text-muted-foreground mt-6 text-center">
          Already have an account? <Link to="/login" className="text-accent font-semibold underline-offset-4 hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
